  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-wrap gap-4 items-center">
        <select 
          className="p-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-[#bf522b] focus:border-[#bf522b] focus:outline-none transition text-[#161616]"
          value={filterCat}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filtered.map(m => {
          ...
          return (
            <Card key={m.id}>
              {/* Contenedor de Imagen con Placeholder de Letra Inicial */}
