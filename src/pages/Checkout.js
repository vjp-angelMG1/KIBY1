...
const Checkout = ({ module, onPurchase, goBack }) => {
  ...
  return (
    <div className="max-w-3xl mx-auto pb-24 md:pb-0"> {/* Padding extra en móvil para que no tape el sticky */}
      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
        ...
        {/* Columna Derecha: Resumen de Pago (Oculto en móvil, visible en desktop) */}
      ...
      {/* BARRA STICKY PARA MÓVIL */}
      <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md p-4 border-t border-gray-200 shadow-[0_-10px_30px_-10px_rgba(0,0,0,0.1)] md:hidden z-40">
        <div className="container mx-auto flex justify-between items-center">
          <div>
            <p className="text-xs text-gray-500 font-semibold">Total a pagar</p>
            <p className="text-2xl font-extrabold text-[#bf522b]">{calculateFinalPrice()}€</p>
          </div>
          <Button onClick={handleConfirmPurchase} className="px-8 justify-center">⚡ Pagar</Button>
        </div>
      </div>
